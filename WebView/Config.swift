...
var pulltorefresh_loadingsigncolour_lightmode = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1) //Set the colour of the pull to refresh loading sign in light mode

var pulltorefresh_backgroundcolour_lightmode = #colorLiteral(red: 0.5725490451, green: 0, blue: 0.2313725501, alpha: 1) //Set the colour of the pull to refresh background in light mode
...
var pulltorefresh_backgroundcolour_darkmode = #colorLiteral(red: 0.2745098174, green: 0.4862745106, blue: 0.1411764771, alpha: 1) //Set the colour of the pull to refresh background in dark mode; requires iOS 13 or higher
...
var statusBarBackgroundColor = #colorLiteral(red: 0.721568644, green: 0.8862745166, blue: 0.5921568871, alpha: 1) //Define a custom status bar background color

var darkModeStatusBarBackgroundColor = #colorLiteral(red: 0.1420632005, green: 0.004622655455, blue: 0.2509362698, alpha: 1) //Define a custom status bar background color while user is using iOS Dark Mode
...
var darkmodeBottombarBackgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) //Define a custom bottom background color while user is using iOS Dark Mode; requires iOS 13 or higher
...
var splashScreenEnabled = false //Set to "false" if you want to disable the Splash Screen while the app launches and display the Loading Sign instead
...
var scaleSplashImage = 0 //Set the splash screen image size with respect to the device's smallest width/height; range in percentage [0-100]; Caution: value  = 0 will hide the image completely
...
static var AdmobBannerID = "" //Set the AdMob ID for banner ads

static var AdmobinterstitialID = "" //Set the AdMob ID for interstitial ads
...
static let ATTDeniedShowAds = false //Set to "false" to stop showing ads entirely if the user denies the AppTrackingTransparency (ATT) permission
